            ...
            next: (marketData) => {
                ...
                const setTickValue = (tick, type) => {
                    ...
                    if (type > api_next_1.IBApiNextTickType.API_NEXT_FIRST_TICK_ID) {
                        changedOrAddedDataWithTickNames.set(api_next_1.IBApiNextTickType[type], value);
                    }
                    else {
                        changedOrAddedDataWithTickNames.set(api_next_1.IBApiTickType[type], value);
                    }
                };
