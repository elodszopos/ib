...
// The help text                                                               //
/////////////////////////////////////////////////////////////////////////////////
const DESCRIPTION_TEXT = "Print historical last trade price Time&Sales data of and instrument.";
...
// The App code                                                             //
//////////////////////////////////////////////////////////////////////////////
class PrintHistoricalTicksLastApp extends ib_api_next_app_1.IBApiNextApp {
    constructor() {
    ...
    start() {
        ...
        (0, rxjs_1.lastValueFrom)(this.api.getHistoricalTicksLast({
            conId: this.cmdLineArgs.conid,
            exchange: this.cmdLineArgs.exchange,
        }, this.cmdLineArgs.start, this.cmdLineArgs.end, this.cmdLineArgs.count, this.cmdLineArgs.rth ?? 1))
            .then((ticks) => {
...
//# sourceMappingURL=historical-ticks-last.js.map