...
describe("configuration lazy loading", () => {
    ...
    test("does not read config files when imported", async () => {
        ...
        await Promise.resolve().then(() => __importStar(require("../../common/configuration")));
    ...
    test("loads config files when a value is read", async () => {
        ...
        jest.doMock("fs", () => ({ readFileSync }));
        jest.doMock("dotenv", () => ({ config }));
        const { default: configuration } = await Promise.resolve().then(() => __importStar(require("../../common/configuration")));
...
//# sourceMappingURL=configuration-lazy.test.js.map