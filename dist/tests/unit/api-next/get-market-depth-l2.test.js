...
describe("RxJS Wrapper: getMarketDepthL2()", () => {
    test("Insert rows", (done) => {
        ...
        api.emit(__1.EventName.updateMktDepth, 1 /* ticker id */, 0 /* position */, 0 /* insert */, 0 /* ask */, 1 /* price */, 2 /* size */);
        eventCount++;
        api.emit(__1.EventName.updateMktDepth, 1 /* ticker id */, 0 /* position */, 0 /* insert */, 1 /* bid */, 11 /* price */, 12 /* size */);
        eventCount++;
        api.emit(__1.EventName.updateMktDepth, 1 /* ticker id */, 1 /* position */, 0 /* insert */, 0 /* ask */, 21 /* price */, 22 /* size */);
        eventCount++;
        api.emit(__1.EventName.updateMktDepth, 1 /* ticker id */, 1 /* position */, 0 /* insert */, 1 /* bid */, 31 /* price */, 32 /* size */);
        eventCount++;
    });
    test("Update rows", (done) => {
        ...
        api.emit(__1.EventName.updateMktDepth, 1 /* ticker id */, 0 /* position */, 0 /* insert */, 0 /* ask */, 1 /* price */, 2 /* size */);
        eventCount++;
        api.emit(__1.EventName.updateMktDepth, 1 /* ticker id */, 0 /* position */, 1 /* update */, 0 /* ask */, 11 /* price */, 12 /* size */);
        eventCount++;
        api.emit(__1.EventName.updateMktDepth, 1 /* ticker id */, 0 /* position */, 0 /* insert */, 1 /* bid */, 1 /* price */, 2 /* size */);
        eventCount++;
        api.emit(__1.EventName.updateMktDepth, 1 /* ticker id */, 0 /* position */, 1 /* update */, 1 /* bid */, 11 /* price */, 12 /* size */);
        eventCount++;
    });
    test("Delete rows", (done) => {
        ...
        api.emit(__1.EventName.updateMktDepth, 1 /* ticker id */, 0 /* position */, 0 /* insert */, 0 /* ask */, 1 /* price */, 2 /* size */);
        eventCount++;
        api.emit(__1.EventName.updateMktDepth, 1 /* ticker id */, 0 /* position */, 2 /* delete */, 0 /* ask */, 11 /* price */, 12 /* size */);
        eventCount++;
    });
});
//# sourceMappingURL=get-market-depth-l2.test.js.map