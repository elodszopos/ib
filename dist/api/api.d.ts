...
import { DurationUnit, MarketDataType, OrderCancel, OrderStatus, WhatToShow } from "..";
...
export declare const MAX_SUPPORTED_SERVER_VERSION = MIN_SERVER_VER.CME_TAGGING_FIELDS_IN_OPEN_ORDER;
...
export declare class IBApi extends EventEmitter {
     ...
     */
    reqHistoricalData(reqId: number, contract: Contract, endDateTime: string | undefined, durationStr: string, barSizeSetting: BarSizeSetting, whatToShow: WhatToShow, useRTH: number | boolean, formatDate: number, keepUpToDate: boolean): IBApi;
    /**
     ...
     */
    reqHistoricalTicks(reqId: number, contract: Contract, startDateTime: string, endDateTime: string | undefined | null, numberOfTicks: number, whatToShow: WhatToShow, useRTH: number | boolean, ignoreSize: boolean): IBApi;
    /**
     ...
     * @see [[cancelMktData]]
     */
    reqMktData(reqId: number, contract: Contract, genericTickList: string | null, snapshot: boolean, regulatorySnapshot: boolean): IBApi;
    /**
     ...
     */
    reqPnLSingle(reqId: number, account: string, modelCode: string | undefined | null, conId: number): IBApi;
    /**
...
export declare interface IBApi {
     ...
     * @see [[reqOpenOrders]]
     */
    on(event: EventName.orderBound, listener: (permId: number, clientId: number, orderId: number) => void): this;
    /**
     ...
     * @see [[reqTickByTickData]]
     */
    on(event: EventName.tickByTickAllLast, listener: (reqId: number, tickType: number, time: string, price: number, size: number, tickAttribLast: TickAttribLast, exchange: string, specialConditions: string) => void): this;
    /**
     ...
     * @see [[reqMktData]]
     */
    on(event: EventName.tickOptionComputation, listener: (reqId: number, field: TickType, tickAttrib: number | undefined, impliedVolatility?: number, delta?: number, optPrice?: number, pvDividend?: number, gamma?: number, vega?: number, theta?: number, undPrice?: number) => void): this;
    /**
