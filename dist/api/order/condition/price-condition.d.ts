...
export declare class PriceCondition implements ContractCondition {
     ...
     */
    constructor(price: number, triggerMethod: TriggerMethod, conId: number | undefined, exchange: string | undefined, isMore: boolean, conjunctionConnection: ConjunctionConnection);
    get strValue(): string;
}
