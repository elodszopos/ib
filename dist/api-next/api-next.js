...
const historicalDataUpdateDurations = {
    [__1.BarSizeSetting.SECONDS_FIVE]: "60 S",
    [__1.BarSizeSetting.SECONDS_TEN]: "60 S",
    [__1.BarSizeSetting.SECONDS_FIFTEEN]: "60 S",
    [__1.BarSizeSetting.SECONDS_THIRTY]: "60 S",
    [__1.BarSizeSetting.MINUTES_ONE]: "60 S",
    [__1.BarSizeSetting.MINUTES_TWO]: "120 S",
    [__1.BarSizeSetting.MINUTES_THREE]: "1800 S",
    [__1.BarSizeSetting.MINUTES_FIVE]: "1800 S",
    [__1.BarSizeSetting.MINUTES_TEN]: "1800 S",
    [__1.BarSizeSetting.MINUTES_FIFTEEN]: "1800 S",
    [__1.BarSizeSetting.MINUTES_TWENTY]: "1800 S",
    [__1.BarSizeSetting.MINUTES_THIRTY]: "1800 S",
    [__1.BarSizeSetting.HOURS_ONE]: "3600 S",
    [__1.BarSizeSetting.HOURS_TWO]: "14400 S",
    [__1.BarSizeSetting.HOURS_THREE]: "14400 S",
    [__1.BarSizeSetting.HOURS_FOUR]: "28800 S",
    [__1.BarSizeSetting.HOURS_EIGHT]: "28800 S",
    [__1.BarSizeSetting.DAYS_ONE]: "1 D",
    [__1.BarSizeSetting.WEEKS_ONE]: "1 W",
    [__1.BarSizeSetting.MONTHS_ONE]: "1 M",
};
const getHistoricalDataUpdateDuration = (barSizeSetting) => historicalDataUpdateDurations[barSizeSetting] ?? "1 D";
...
class IBApiNext {
    ...
    constructor(options) {
        ...
        this.onTickOptionComputation = (subscriptions, reqId, field, _tickAttrib, impliedVolatility, delta, optPrice, pvDividend, gamma, vega, theta, undPrice) => {
            // get subscription
            const subscription = subscriptions.get(reqId);
            if (!subscription) {
                return;
        ...
        this.api = new auto_connection_1.IBApiAutoConnection(options?.reconnectInterval ?? 0, (options?.connectionWatchdogInterval ?? 0) * 1_000, this.logger, options);
    ...
    getAccountSummary(group, tags) {
        return this.subscriptions.register((reqId) => {
            ...
            [
                __1.EventName.accountSummary,
                this
                    .onAccountSummary,
            ],
            [
                __1.EventName.accountSummaryEnd,
                this
                    .onAccountSummaryEnd,
            ],
        ], `getAccountSummary+${group}:${tags}`);
    ...
    getAccountUpdates(acctCode) {
        return this.subscriptions.register(() => {
            ...
            [
                __1.EventName.updateAccountValue,
                this.onUpdateAccountValue,
            ],
            [
                __1.EventName.updatePortfolio,
                this.onUpdatePortfolio,
            ],
            [
                __1.EventName.accountDownloadEnd,
                this.onAccountDownloadEnd,
            ],
            [
                __1.EventName.updateAccountTime,
                this.onUpdateAccountTime,
            ],
    ...
    getContractDetails(contract) {
        return (0, rxjs_1.lastValueFrom)(this.subscriptions
            ...
            [
                __1.EventName.contractDetails,
                this.onContractDetails,
            ],
            [
                __1.EventName.bondContractDetails,
                this.onContractDetails,
            ],
            [
                __1.EventName.contractDetailsEnd,
                this.onContractDetailsEnd,
            ],
        ])
            .pipe((0, operators_1.map)((v) => v.all)), {
            defaultValue: [],
    ...
    getSecDefOptParams(underlyingSymbol, futFopExchange, underlyingSecType, underlyingConId) {
        return (0, rxjs_1.lastValueFrom)(this.subscriptions
            ...
            [
                ...
                this
                    .onSecurityDefinitionOptionParameterEnd,
            ],
        ])
            .pipe((0, operators_1.map)((v) => v.all)), {
            defaultValue: [],
    ...
    getMarketData(contract, genericTickList, snapshot, regulatorySnapshot) {
        return this.subscriptions.register((reqId) => {
            ...
            [
                __1.EventName.tickPrice,
                this.onTick,
            ],
            [
                __1.EventName.tickSize,
                this.onTick,
            ],
            [
                __1.EventName.tickGeneric,
                this.onTick,
            ],
            [
                __1.EventName.tickString,
                this.onTickString,
            ],
            [
                __1.EventName.tickOptionComputation,
                this
                    .onTickOptionComputation,
            ],
            [
                __1.EventName.tickSnapshotEnd,
                this.onTickSnapshotEnd,
            ],
    ...
    getMarketDataSnapshot(contract, genericTickList, regulatorySnapshot) {
        return (0, rxjs_1.lastValueFrom)(this.getMarketData(contract, genericTickList, true, regulatorySnapshot).pipe((0, operators_1.map)((v) => new mutable_market_data_1.MutableMarketData(v.all))), {
    ...
    getHeadTimestamp(contract, whatToShow, useRTH, formatDate) {
        return (0, rxjs_1.lastValueFrom)(this.subscriptions
            ...
            [
                __1.EventName.headTimestamp,
                this.onHeadTimestamp,
            ],
        ], `getHeadTimestamp+${JSON.stringify(contract)}:${whatToShow}:${useRTH}:${formatDate}`)
            .pipe((0, operators_1.map)((v) => v.all)), {
            defaultValue: "",
        });
    }
    ...
    getHistoricalData(contract, endDateTime, durationStr, barSizeSetting, whatToShow, useRTH, formatDate) {
        return (0, rxjs_1.lastValueFrom)(this.subscriptions
            ...
            [
                __1.EventName.historicalData,
                this.onHistoricalData,
            ],
        ])
            .pipe((0, operators_1.map)((v) => v.all)), {
            defaultValue: [],
    ...
    getHistoricalDataUpdates(contract, barSizeSetting, whatToShow, formatDate) {
        return this.subscriptions
            .register((reqId) => {
            this.api.reqHistoricalData(reqId, contract, "", getHistoricalDataUpdateDuration(barSizeSetting), barSizeSetting, whatToShow, 0, formatDate, true);
        }, (reqId) => {
            this.api.cancelHistoricalData(reqId);
        }, [
            [
                __1.EventName.historicalDataUpdate,
    ...
    getHistoricalTicksMid(contract, startDateTime, endDateTime, numberOfTicks, useRTH) {
        return this.subscriptions
            ...
            [
                __1.EventName.historicalTicks,
                this.onHistoricalTicks,
            ],
        ])
            .pipe((0, operators_1.map)((v) => v.all));
    }
    ...
    getHistoricalTicksBidAsk(contract, startDateTime, endDateTime, numberOfTicks, useRTH, ignoreSize) {
        return this.subscriptions
            ...
            [
                __1.EventName.historicalTicksBidAsk,
                this.onHistoricalTicksBidAsk,
            ],
        ])
            .pipe((0, operators_1.map)((v) => v.all));
    }
    ...
    getHistoricalTicksLast(contract, startDateTime, endDateTime, numberOfTicks, useRTH) {
        return this.subscriptions
            ...
            [
                __1.EventName.historicalTicksLast,
                this.onHistoricalTicksLast,
            ],
        ])
            .pipe((0, operators_1.map)((v) => v.all));
    }
    ...
    getMarketDepthExchanges() {
        return (0, rxjs_1.lastValueFrom)(this.subscriptions
            ...
            [
                __1.EventName.mktDepthExchanges,
                this.onMktDepthExchanges,
            ],
        ], "getMarketDepthExchanges")
            .pipe((0, operators_1.map)((v) => v.all)), {
            defaultValue: [],
    ...
    getMarketDepth(contract, numRows, isSmartDepth, mktDepthOptions) {
        return this.subscriptions.register((reqId) => {
            ...
            [
                __1.EventName.updateMktDepth,
                this.onUpdateMktDepth,
            ],
            [
                __1.EventName.updateMktDepthL2,
    ...
    getScannerParameters() {
        return (0, rxjs_1.lastValueFrom)(this.subscriptions
            ...
            [
                __1.EventName.scannerParameters,
                this.onScannerParameters,
            ],
        ], "getScannerParameters")
            .pipe((0, operators_1.map)((v) => v.all)), {
            defaultValue: "",
    ...
    getMarketScanner(scannerSubscription, scannerSubscriptionOptions, scannerSubscriptionFilterOptions) {
        return this.subscriptions.register((reqId) => {
            ...
            [
                __1.EventName.scannerData,
                this.onScannerData,
            ],
            [
                __1.EventName.scannerDataEnd,
                this.onScannerDataEnd,
            ],
        ]);
    }
    /**
    ...
    getHistogramData(contract, useRTH, duration, durationUnit) {
        return (0, rxjs_1.lastValueFrom)(this.subscriptions
            ...
            [
                __1.EventName.histogramData,
                this.onHistogramData,
            ],
        ], `getHistogramData+${JSON.stringify(contract)}:${useRTH}:${duration}:${durationUnit}`)
            .pipe((0, operators_1.map)((v) => v.all)), {
            defaultValue: [],
        });
    }
    ...
    getAllOpenOrders() {
        return (0, rxjs_1.lastValueFrom)(this.subscriptions
            ...
            [
                __1.EventName.openOrder,
                this.onOpenOrder,
            ],
            [
                __1.EventName.orderStatus,
                this.onOrderStatus,
            ],
            [
                __1.EventName.orderBound,
                this.onOrderBound,
            ],
            [
                __1.EventName.openOrderEnd,
                this.onOpenOrderComplete,
            ],
        ], "getAllOpenOrders")
            .pipe((0, operators_1.map)((v) => v.all)), {
            defaultValue: [],
    ...
    getExecutionDetails(filter) {
        return (0, rxjs_1.lastValueFrom)(this.subscriptions
            ...
            [
                __1.EventName.execDetails,
                this.onExecDetails,
            ],
            [
                __1.EventName.execDetailsEnd,
                this.onExecDetailsEnd,
            ],
        ])
            .pipe((0, operators_1.map)((v) => v.all)), {
            defaultValue: [],
    ...
    getCommissionReport(filter) {
        return (0, rxjs_1.lastValueFrom)(this.subscriptions
            ...
            [
                __1.EventName.commissionReport,
                this.onComissionReport,
            ],
            [
                __1.EventName.execDetailsEnd,
                this.onExecDetailsEnd,
    ...
    getMatchingSymbols(pattern) {
        return (0, rxjs_1.lastValueFrom)(this.subscriptions
            ...
            [
                __1.EventName.symbolSamples,
                this.onSymbolSamples,
            ],
        ])
            .pipe((0, operators_1.map)((v) => v.all)));
    }
    ...
    getFundamentalData(contract, reportType, fundamentalDataOptions = []) {
        return (0, rxjs_1.lastValueFrom)(this.subscriptions
            ...
            [
                __1.EventName.fundamentalData,
                this.onFundamentalData,
            ],
        ])
            .pipe((0, operators_1.map)((v) => v.all)), {
