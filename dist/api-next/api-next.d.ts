...
export type IBApiNextEventHandler<T> = (subscriptions: Map<number, IBApiNextSubscription<T>>, ...eventArgs: unknown[]) => void;
/**
...
export declare class IBApiNext {
     ...
     */
    getPnLSingle(account: string, modelCode: string | undefined | null, conId: number): Observable<PnLSingle>;
    /**
     ...
     */
    getMarketData(contract: Contract, genericTickList: string | null, snapshot: boolean, regulatorySnapshot: boolean): Observable<MarketDataUpdate>;
    /**
     ...
     */
    getHistoricalTicksBidAsk(contract: Contract, startDateTime: string, endDateTime: string | undefined | null, numberOfTicks: number, useRTH: number | boolean, ignoreSize: boolean): Observable<HistoricalTickBidAsk[]>;
     ...
     * @param useRTH Data from regular trading hours (true), or all available hours (false)
     */
    getHistoricalTicksLast(contract: Contract, startDateTime: string, endDateTime: string | undefined | null, numberOfTicks: number, useRTH: number | boolean): Observable<HistoricalTickLast[]>;
     ...
     */
    getFundamentalData(contract: Contract, reportType: string, fundamentalDataOptions?: TagValue[]): Promise<string | undefined>;
}
