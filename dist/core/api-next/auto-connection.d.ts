...
export declare class IBApiAutoConnection extends IBApi {
    ...
    readonly options?: IBApiCreationOptions | undefined;
    /**
     ...
     */
    constructor(reconnectInterval: number, watchdogInterval: number, logger: Logger, options?: IBApiCreationOptions | undefined);
    /**
