...
const order_status_1 = require("../../api/order/enum/order-status");
...
class Decoder {
    ...
    decodeMsg_OPEN_ORDER() {
        ...
        const version = this.serverVersion < min_server_version_1.default.ORDER_CONTAINER
            ...
            : this.serverVersion;
        const contract = {};
        const order = { orderType: orderType_1.OrderType.MKT }; // would be overwritten
        const orderState = { status: order_status_1.OrderStatus.Unknown };
    ...
    decodeMsg_TICK_OPTION_COMPUTATION() {
        ...
        this.emit(event_name_1.EventName.tickOptionComputation, tickerId, tickType, _tickAttrib, impliedVol, delta, optPrice, pvDividend, gamma, vega, theta, undPrice);
    }
    /**
