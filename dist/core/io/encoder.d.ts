...
export declare class Encoder {
     ...
     */
    reqHistoricalData(reqId: number, contract: Contract, endDateTime: string | undefined, durationStr: string, barSizeSetting: BarSizeSetting, whatToShow: WhatToShow, useRTH: number | boolean, formatDate: number, keepUpToDate: boolean, chartOptions?: TagValue[]): void;
    /**
     ...
     */
    reqHistoricalNews(reqId: number, conId: number, providerCodes: string, startDateTime: string, endDateTime: string | undefined, totalResults: number, historicalNewsOptions: TagValue[]): void;
    /**
