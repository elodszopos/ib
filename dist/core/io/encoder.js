...
class Encoder {
  ...
  function tagValuesToTokens(tagValues: TagValue[]): unknown[] {
    ...
    cancelOrder(orderId, orderCancel) {
        ...
        const tokens = [OUT_MSG_ID.CANCEL_ORDER];
        if (this.serverVersion < min_server_version_1.default.CME_TAGGING_FIELDS)
            tokens.push(version);
        tokens.push(orderId);
        if (this.serverVersion >= min_server_version_1.default.MANUAL_ORDER_TIME)
    ...
    placeOrder(id, contract, order) {
        ...
        if (this.serverVersion < min_server_version_1.default.INCLUDE_OVERNIGHT) {
            if (order.includeOvernight) {
                return this.emitError("It does not support include overnight parameter", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
        if (this.serverVersion < min_server_version_1.default.CME_TAGGING_FIELDS) {
            if (order.manualOrderIndicator) {
                return this.emitError("It does not support manual order indicator parameter", errorCode_1.ErrorCode.UPDATE_TWS, id);
            }
        }
    ...
    reqGlobalCancel(orderCancel) {
        ...
        const tokens = [OUT_MSG_ID.REQ_GLOBAL_CANCEL];
        if (this.serverVersion < min_server_version_1.default.CME_TAGGING_FIELDS) {
            tokens.push(version);
        }
        if (this.serverVersion >= min_server_version_1.default.CME_TAGGING_FIELDS) {
    ...
    reqWshMetaData(reqId) {
        if (this.serverVersion < min_server_version_1.default.WSHE_CALENDAR) {
            return this.emitError("It does not support WSHE Calendar API.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
    ...
    reqUserInfo(reqId) {
        if (this.serverVersion < min_server_version_1.default.USER_INFO) {
            return this.emitError("It does not support user info requests.", errorCode_1.ErrorCode.UPDATE_TWS, reqId);
        }
