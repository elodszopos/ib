...
export class CommandBuffer<TType> {
  private readonly cb: (type: TType, data: unknown) => void;
  private readonly cbCtx: unknown;
  private commands: Array<{ type: TType; data: unknown }> = [];
  private commandsCurrent: Array<{ type: TType; data: unknown }> = [];
  private paused = false;
  private processing = false;

  constructor(
    onCommandCallback: (type: TType, data: unknown) => void,
